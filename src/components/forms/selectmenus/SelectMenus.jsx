        ...
        <div className="row ma-0 select-menus-block">
          ...
          <div className="col-lg-6 ptb-15">
            <div className="roe-card-style">
              ...
              <div className="roe-card-body">
                <div className="roe-card-description">
                  This is a multi select menu you can choose more than one
                  options.
                </div>
                <Select
                  defaultValue={[
                    BasicMultiSelectOption[2],
                    BasicMultiSelectOption[3],
                  ]}
                  isMulti
                  placeholder="select options"
                  name="colors"
          ...
          <div className="col-lg-6 ptb-15">
            <div className="roe-card-style">
              ...
              <div className="roe-card-body">
                <div className="roe-card-description">
                  This is a single select menu with customize using different
                  colors.
                </div>
                <Select
          ...
          <div className="col-lg-6 ptb-15">
            <div className="roe-card-style">
              ...
              <div className="roe-card-body">
                <div className="roe-card-description">
                  This is a multi select menu with customize using different
                  colors.
                </div>
                <Select
                  closeMenuOnSelect={false}
                  defaultValue={[
                    BasicMultiSelectOption[0],
                    BasicMultiSelectOption[1],
                  ]}
                  isMulti
                  options={BasicMultiSelectOption}
                  styles={colourStyles}
